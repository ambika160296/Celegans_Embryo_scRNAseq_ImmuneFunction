...
genes.df <- getBM(mart = mart, 
      ...
      value = list("caelegprjna13758", rownames(emb.GFPpooled_v1.data)),
...
c(nrow(genes.df), nrow(emb.GFPpooled_v1.data))

# there are genes missing
nrow(emb.GFPpooled_v1.data)-nrow(genes.df)
```
```{r}
mart <- useMart("parasite_mart", dataset = "wbps_gene", host = "https://parasite.wormbase.org", port = 443)
...
```{r}
emb.GFPpooled_v1.data.filt <- emb.GFPpooled_v1.data[rownames(emb.GFPpooled_v1.data) %in% genes.df$external_gene_id,]

# The two data structures do not have the same order of WBGeneIDs
identical(rownames(emb.GFPpooled_v1.data.filt), genes.df$external_gene_id)

# Use match to make sure they are in the same order
identical(rownames(emb.GFPpooled_v1.data.filt),
          genes.df[match(rownames(emb.GFPpooled_v1.data.filt), genes.df$external_gene_id),]$external_gene_id)
...
# are there NAs?
sum(!is.na(rownames(emb.GFPpooled_v1.data.filt)))

head(emb.GFPpooled_v1.data.filt)
```
```{r}
...
cellcodes <- as.data.frame(emb.GFPpooled_v1.data.filt@Dimnames[[2]])
...
```{r}
emb.GFPpooled_v1 <- CreateSeuratObject(counts = emb.GFPpooled_v1.data.filt, project = "emb.GFPpooled_v1", min.cells = 3, min.features = 200, meta.data = cellcodes)

view(emb.GFPpooled_v1@meta.data)
```
```{r}
...
```{r}
emb.GFPpooled_v1[["RNA"]] <- split(emb.GFPpooled_v1[["RNA"]], f = emb.GFPpooled_v1$rep_group)
emb.GFPpooled_v1
...
length(unique(rownames(emb.GFPpooled_v1)))
rownames(emb.GFPpooled_v1)[!(rownames(emb.GFPpooled_v1) %in% genes.df$external_gene_id)]
...
view(emb.GFPpooled_v1@meta.data)
head(emb.GFPpooled_v1@meta.data, 5)
...
```{r}
mitoIndices = which(rownames(emb.GFPpooled_v1) %in% mitoList)
emb.GFPpooled_v1[["percent.mt"]] <- PercentageFeatureSet(emb.GFPpooled_v1, features = mitoIndices)
...
```{r}
VlnPlot(emb.GFPpooled_v1, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3) 
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.VlnPlot.png")
...
```{r}
plot1 <- FeatureScatter(emb.GFPpooled_v1, feature1 = "nCount_RNA", feature2 = "percent.mt") + geom_hline(yintercept = 50)
plot2 <- FeatureScatter(emb.GFPpooled_v1, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
plot1 + plot2
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.FeatureScatter.png")
...
```{r}
sum(emb.GFPpooled_v1$percent.mt > 50)/ length(emb.GFPpooled_v1$percent.mt)
emb.GFPpooled_v1 <- subset(emb.GFPpooled_v1, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 & nCount_RNA < 50000 & percent.mt < 50)
...
```{r}
VlnPlot(emb.GFPpooled_v1, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"))
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.VlnPlot.filt.png")

FeatureScatter(emb.GFPpooled_v1, feature1 = "nCount_RNA", feature2 = "nFeature_RNA")
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.FeatureScatter.filt.png")
...
```{r}
view(emb.GFPpooled_v1@meta.data)
hist(emb.GFPpooled_v1$nFeature_RNA)
hist(emb.GFPpooled_v1$nCount_RNA)

view(emb.GFPpooled_v1@assays$RNA$counts)
exp_matrix <- as.matrix(emb.GFPpooled_v1@assays$RNA$counts)
...
```{r}
emb.GFPpooled_v1 <- NormalizeData(emb.GFPpooled_v1, normalization.method = "LogNormalize", scale.factor = 10000)
...
```{r}
emb.GFPpooled_v1 <- FindVariableFeatures(emb.GFPpooled_v1, selection.method = "vst", nfeatures = 2000)

emb.GFPpooled_v2 <- FindVariableFeatures(emb.GFPpooled_v2, selection.method = "vst", nfeatures = 2000)

# Identify the 10 most highly variable genes
top10 <- head(VariableFeatures(emb.GFPpooled_v1), 10)
top10_1 <- head(VariableFeatures(emb.GFPpooled_v2), 10)

# plot variable features with and without labels
plot1 <- VariableFeaturePlot(emb.GFPpooled_v1)
LabelPoints(plot = plot1, points = top10, repel = TRUE)
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.VarFeatures.png")

plot1 <- VariableFeaturePlot(emb.GFPpooled_v2)
LabelPoints(plot = plot1, points = top10_1, repel = TRUE)
...
```{r}
all.genes <- rownames(emb.GFPpooled_v1)
emb.GFPpooled_v1 <- ScaleData(emb.GFPpooled_v1, features = all.genes)
...
```{r}
emb.GFPpooled_v1 <- RunPCA(emb.GFPpooled_v1, features = VariableFeatures(object = emb.GFPpooled_v1))
...
```{r}
print(emb.GFPpooled_v1[["pca"]], dims = 1:5, nfeatures = 5)
...
VizDimLoadings(emb.GFPpooled_v1, dims = 1:2, reduction = "pca")
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.DimLoadings.png")
...
DimPlot(emb.GFPpooled_v1, reduction = "umap.unintegrated", group.by = c("rep_group", "seurat_clusters"), label = "TRUE", label.box = TRUE, label.size = 3, pt.size = 3) + 
...
DimPlot(emb.GFPpooled_v2, reduction = "umap.unintegrated", group.by = c("rep_group", "seurat_clusters"), label = "TRUE", label.box = TRUE, label.size = 3, pt.size = 3) + 
  theme(axis.title.x = element_text(size = 20),
        axis.ticks.x = element_line(size = 6),
        axis.title.y = element_text(size = 20),
        axis.ticks.y = element_line(size = 6),
...
ggsave("./Seurat_output/all_GFP_v1/emb.GFPpooled_v1.UMAP.int.rep.png")
```
```{r}
...
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.UMAP.int.png")

DimPlot(emb.GFPpooled_v2, reduction = "umap.cca", split.by = "rep_group")
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.UMAP.int.rep.png")
```
...
DoHeatmap(emb.GFPpooled_v2, features = c(top2$gene, "clec-56", "pbo-4", "C14C6.5", "ugt-14", "endu-2", "cpr-1", "Y32F6A.5"), raster=F) + 
  theme(axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))          
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.HeatMap-top2.png")

# RNAi 
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.cca", features = c("C14C6.5", "cpr-1", "Y32F6A.5", "endu-2", "clec-56", "pbo-4", "ugt-14"), ncol = 3)
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.featureplot.rnai.png")

#intestine
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.cca", features = c("elt-2", "elt-7", "end-1", "acp-2", "ges-1"), ncol = 2)
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.featureplot.intestine.png")

# germline
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.cca", features = c("glh-1", "chs-1"))
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.featureplot.germ.png")

# neuron
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.cca", features = c("hlh-2", "rab-3"))
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.featureplot.neuron.png")

# muscle
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.cca", features = c("myo-2", "myo-3"))
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.featureplot.muscle.png")


# early intestine
FeaturePlot(emb.GFPpooled_v2, reduction = "umap.cca", features = c("end-1", "acp-2", "ugt-14"))
ggsave("./Seurat_output/all_GFP_v2/emb.GFPpooled_v2.featureplot.earlyint.png")
#-------------------- 

quartz(width = 10, height = 4)
FeaturePlot(emb.GFPpooled, features = c("elt-2","elt-7",'ges-1',"end-1","acp-2","C10C5.4"),raster=F, ncol = 3) + 
  theme(axis.title.x = element_text(size = 12),
        axis.text.x = element_text(size = 14),
        axis.title.y = element_text(size = 12),
        axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.FeaturePlot-PosCtrls.png")



quartz(width = 10, height = 8)
FeaturePlot(emb.GFPpooled, features = c("glh-1","chs-1", "myo-2", "myo-3", "hlh-2", "rab-3"), raster=F, ncol = 2) +
  theme(axis.title.x = element_text(size = 12),
        axis.text.x = element_text(size = 14),
        axis.title.y = element_text(size = 12),
        axis.text.y = element_text(size = 14),
...
FeaturePlot(emb.GFPpooled, features = c("C14C6.5","clec-56", "pbo-4"),raster=F, ncol = 1) +
  theme(axis.title.x = element_text(size = 12),
        ...
        axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.FeaturePlot-FISH.png")





emb.ALLpooled.markers %>% group_by(cluster) %>% filter(p_val_adj < .01) %>% top_n(n=2, wt=avg_log2FC) -> top2

quartz(width = 12, height = 4)
FeaturePlot(emb.ALLpooled, features = c("elt-2","elt-7", 'ges-1'),raster=F, ncol = 3) + 
  theme(axis.title.x = element_text(size = 12),
        axis.text.x = element_text(size = 14),
        axis.title.y = element_text(size = 12),
        axis.text.y = element_text(size = 14),
        legend.text = element_text(size = 14))
ggsave("./Seurat_output/GFP_pooled/emb.ALLpooled.FeaturePlot-PostCtrls.png")
```


```{r}
#how many cells are expressing these markers of other tissues?
view(emb.GFPpooled@assays$RNA$data)

total_cells_expressing_gene <- sum(emb.GFPpooled@assays$RNA$data["hlh-2", ] > 0)
print(total_cells_expressing_gene)

total_cells_expressing_gene <- sum(emb.GFPpooled@assays$RNA$data["myo-3", ] > 0)
print(total_cells_expressing_gene)

total_cells_expressing_gene <- sum(emb.GFPpooled@assays$RNA$data["rab-3", ] > 0)
print(total_cells_expressing_gene)
```
...
emb.GFPpooled.markers <- emb.GFPpooled.markers %>% rename(WBGeneID = wbps_gene_id)
```
...
ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.GO_T.png", limitsize = FALSE)
```
...
my_ontology_plot(my_tea_analysis(emb.GFPpooled.markers %>% filter(p_val_adj < 0.04, avg_log2FC > 1), go_df), "Gene Ontology") + theme(text = element_text(size = 30))

ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.GO_G.png", limitsize = FALSE)
```
...
ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.HeatMap-top2.png")


# intestine marker genes
FeaturePlot(emb.GFPpooled.specificClusters.recluster, features = c("elt-2","elt-7", 'ges-1'),raster=F, ncol = 2)
ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.FeaturePlot-PostCtrls.png")
...
ggsave("./Seurat_output/GFP_pooled/emb.GFPpooled.ContaminationRemoved.FeaturePlot-NegCtrls.png")
```
